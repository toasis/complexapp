...
export default class Search {
  ...
  constructor() {
    ...
    /*this.events()->
    Stay organized and keep all events we are listening for one area without      cluttering up our constructor but they will indeed begin listening or running as soon as the object is created.
     */
    this.events();
  }
  //2. Events
  ...
  //3. Methods
  keyPressHandler() {
    let value = this.inputField.nodeValue;
